...
class BookingTableRow extends StatefulWidget {
  ...
  final BookingTableController controller;
...
class _BookingTableRowState extends State<BookingTableRow> {
  ...
  Widget _buildRow() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: widget.controller.selectedBooking.value == widget.booking
      ...
      child: Row(
        children: [
          Expanded(child: _buildCell(widget.booking.id, centered: false)),
          const SizedBox(width: 16),
          Expanded(
            child: _buildCell(widget.booking.customerName, centered: false),
          ),
          const SizedBox(width: 16),
  ...
  Widget _buildNoteCell() {
    return widget.booking.note != null && widget.booking.note!.isNotEmpty
        ? Tooltip(
